...
export class VennDiagramComponent implements OnInit {
  ...
  sqlQueries: Record<string, string> = {
    inner: `<span class="text-[#C778DD] font-bold">SELECT</span> A.Name, B.Dept_Name\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> A\n<span class="text-[#C778DD] font-bold">INNER JOIN</span> <span class="text-[#61AFEF]">Departments</span> B\n<span class="text-[#C778DD] font-bold">ON</span> A.Dept_ID = B.Dept_ID;`,
    left: `<span class="text-[#C778DD] font-bold">SELECT</span> A.Name, B.Dept_Name\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> A\n<span class="text-[#C778DD] font-bold">LEFT OUTER JOIN</span> <span class="text-[#61AFEF]">Departments</span> B\n<span class="text-[#C778DD] font-bold">ON</span> A.Dept_ID = B.Dept_ID;`,
    right: `<span class="text-[#C778DD] font-bold">SELECT</span> A.Name, B.Dept_Name\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> A\n<span class="text-[#C778DD] font-bold">RIGHT OUTER JOIN</span> <span class="text-[#61AFEF]">Departments</span> B\n<span class="text-[#C778DD] font-bold">ON</span> A.Dept_ID = B.Dept_ID;`,
    full: `<span class="text-[#C778DD] font-bold">SELECT</span> A.Name, B.Dept_Name\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> A\n<span class="text-[#C778DD] font-bold">FULL OUTER JOIN</span> <span class="text-[#61AFEF]">Departments</span> B\n<span class="text-[#C778DD] font-bold">ON</span> A.Dept_ID = B.Dept_ID;`,
    cross: `<span class="text-[#C778DD] font-bold">SELECT</span> A.Name, B.Dept_Name\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> A\n<span class="text-[#C778DD] font-bold">CROSS JOIN</span> <span class="text-[#61AFEF]">Departments</span> B;`,
    self: `<span class="text-[#C778DD] font-bold">SELECT</span> E.Name <span class="text-[#C778DD] font-bold">AS</span> Employee, M.Name <span class="text-[#C778DD] font-bold">AS</span> Manager\n<span class="text-[#C778DD] font-bold">FROM</span> <span class="text-[#61AFEF]">Employees</span> E\n<span class="text-[#C778DD] font-bold">LEFT JOIN</span> <span class="text-[#61AFEF]">Employees</span> M\n<span class="text-[#C778DD] font-bold">ON</span> E.Manager_ID = M.Emp_ID;`
  };
